const VERSION="suphan-pwa-v183";
const APP_SHELL=["./","./index.html","./css/app.css?v=login-v2","./css/home-depth.css?v=home-depth-v5","./js/runtime-config.js","./js/app.js?v=app-v59","./js/api.js?v=api-v12","./js/pos.js?v=pos-v19","./js/product.js","./js/stock.js?v=stock-v4","./js/expense.js?v=expense-v13","./js/preorder.js?v=preorder-v17","./js/outsource.js?v=outsource-v3","./js/report.js?v=report-v18","./js/settings.js?v=settings-v10","./js/workshop.js?v=workshop-v27","./js/claim.js?v=claim-v4","./js/barcode.js?v=barcode-v4","./js/receipt.js?v=receipt-v1","./css/stocktake.css?v=stocktake-v1","./js/stocktake.js?v=stocktake-v1"];
