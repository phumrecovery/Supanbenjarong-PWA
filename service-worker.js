const VERSION="suphan-pwa-v34";
const APP_SHELL=["./","./index.html","./css/app.css","./css/pos.css","./css/product.css","./js/app.js","./js/api.js","./js/pos.js","./js/product.js","./assets/icon-48.png","./assets/icon-192.png","./assets/icon-512.png","./manifest.webmanifest"];
