const VERSION="suphan-pwa-v108";
const APP_SHELL=["./","./index.html","./css/app.css","./css/pos.css","./css/product.css","./css/product-overrides.css","./css/stock.css?v=stock-v1","./css/expense.css","./css/expense-day-groups.css","./css/preorder.css","./css/preorder-fixes.css","./css/outsource.css","./css/report.css","./css/report-print-parity.css","./css/settings.css?v=settings-v5","./js/app.js?v=app-v2","./js/api.js","./js/pos.js","./js/product.js","./js/stock.js?v=stock-v1","./js/expense.js","./js/preorder.js","./js/outsource.js","./js/report.js","./js/settings.js?v=settings-v9","./assets/icon-48.png","./assets/icon-192.png","./assets/icon-512.png","./manifest.webmanifest"];
