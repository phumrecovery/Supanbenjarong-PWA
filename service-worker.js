const VERSION="suphan-pwa-v32";
const APP_SHELL=["./","./index.html","./css/app.css","./js/app.js","./js/api.js","./assets/icon-48.png","./assets/icon-192.png","./assets/icon-512.png","./manifest.webmanifest"];
