const VERSION="suphan-pwa-v50";
const APP_SHELL=["./","./index.html","./css/app.css","./css/pos.css","./css/product.css","./css/product-overrides.css","./css/expense.css","./js/app.js","./js/api.js","./js/pos.js","./js/product.js","./js/expense.js","./assets/icon-48.png","./assets/icon-192.png","./assets/icon-512.png","./manifest.webmanifest"];
