...
const CACHE="suphan-worker-v10";
const SHELL=["./","./index.html","./worker.css","./worker.js","./manifest.webmanifest","../js/api.js","../js/runtime-config.js","../assets/worker-app-icon.png"];
