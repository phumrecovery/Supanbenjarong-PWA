...
const CACHE="suphan-worker-v16";
const SHELL=["./","./index.html","./worker.css","./worker-save-feedback.css?v=save-v1","./worker.js?v=worker-v16","./manifest.webmanifest","../js/api.js","../js/runtime-config.js","../assets/worker-app-icon.png"];
