...
const CACHE="suphan-worker-v15";
const SHELL=["./","./index.html","./worker.css","./worker.js?v=worker-v15","./manifest.webmanifest","../js/api.js","../js/runtime-config.js","../assets/worker-app-icon.png"];
