...
const CACHE="suphan-worker-v22";
const SHELL=["./","./index.html","./worker.css","./worker-save-feedback.css?v=save-v1","./worker.js?v=worker-v22","./manifest.webmanifest","../js/api.js?v=worker-login-v1","../js/runtime-config.js","../assets/worker-app-icon.png"];
