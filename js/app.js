import {ApiClient} from "./api.js?v=api-v2";
import {renderPos} from "./pos.js?v=pos-v17";
import {renderProduct} from "./product.js";
import {renderStock} from "./stock.js?v=stock-v2";
...
import {renderWorkshop} from "./workshop.js?v=workshop-v11";
...
if("serviceWorker" in navigator)navigator.serviceWorker.register("./service-worker.js?v=109").catch(()=>{});
initialize();
